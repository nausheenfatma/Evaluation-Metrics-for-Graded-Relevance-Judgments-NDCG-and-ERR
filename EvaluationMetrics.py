...
if __name__=='__main__' :
    e=Evaluation()
    e.set_max_grade(4) #set the maximum grade in graded judgements,min_grade=0,default maxgrade=4

    average_NDCG=e.find_average_NDCG([[2,3,1,4,1,2,2,3],[1,2,3,3,4,0,0]]) #list of evaluated ranked lists
